...
const openapi = {
  ...
  tags: [
    ...
    {
      name: 'Provider',
      description: 'Provider nursery management, photos, fees, availability, staff',
    },
    ...
    {
      name: 'Admin',
      description: 'Admin dashboard — stats, users, claims, reviews, enquiries, bookings',
    },
  ...
  paths: {
    ...
    '/api/v1/nurseries/search': {
      post: {
        ...
        responses: {
          ...jsonOk('Paginated search results', 'NurserySearchResult'),
    ...
    '/api/v1/nurseries/smart-search': {
      post: {
        tags: ['Nurseries'],
        summary: 'Smart search with natural language query',
    ...
    '/api/v1/nurseries/compare': {
      post: {
        tags: ['Nurseries'],
        summary: 'Compare multiple nurseries side by side',
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['urns'],
                properties: { urns: { type: 'array', items: { type: 'string' }, maxItems: 5 } },
              },
            },
          },
        },
        responses: jsonOk('Comparison data', {
          type: 'object',
          properties: { data: { type: 'array', items: { $ref: '#/components/schemas/Nursery' } } },
        }),
      },
    },
    '/api/v1/nurseries/fees': {
      post: {
        tags: ['Nurseries'],
        summary: 'Get fees for multiple nurseries',
        operationId: 'getNurseryFees',
        requestBody: {
          required: true,
          content: {
            'application/json': {
    ...
    '/api/v1/nurseries/autocomplete': {
      get: {
        tags: ['Nurseries'],
        summary: 'Autocomplete nursery names',
        operationId: 'autocompleteNurseries',
        parameters: [
          { in: 'query', name: 'q', required: true, schema: { type: 'string' } },
          { in: 'query', name: 'limit', schema: { type: 'integer', default: 10 } },
        ],
        responses: jsonOk('Suggestions', {
          type: 'object',
    ...
    '/api/v1/nurseries/towns': {
      get: {
        tags: ['Nurseries'],
        summary: 'List all towns with nurseries',
        operationId: 'listTowns',
        responses: jsonOk('Town list', { type: 'object' }),
      },
    },
    '/api/v1/nurseries/by-town/{town}': {
      get: {
        tags: ['Nurseries'],
        summary: 'List nurseries in a town',
        operationId: 'nurseryByTown',
    ...
    '/api/v1/nurseries/{urn}/similar': {
      get: {
        tags: ['Nurseries'],
        summary: 'Get similar nurseries',
        operationId: 'similarNurseries',
        parameters: [
          urnParam,
    ...
    '/api/v1/nurseries/{urn}/availability': {
      get: {
        tags: ['Nurseries'],
        summary: 'Get nursery availability',
    ...
    '/api/v1/nurseries/{urn}/view': {
      post: {
        ...
        summary: 'Record a nursery page view',
        operationId: 'recordNurseryView',
        parameters: [urnParam],
    ...
    '/api/v1/nurseries/{urn}/reviews': {
      get: {
        tags: ['Reviews'],
        summary: 'List reviews for a nursery',
    ...
    '/api/v1/nurseries/{urn}/questions': {
      get: {
        tags: ['Q&A'],
        summary: 'List questions for a nursery',
      ...
      post: {
        tags: ['Q&A'],
        summary: 'Ask a question about a nursery',
    ...
    '/api/v1/nurseries/{urn}/questions/{questionId}/answers': {
      post: {
        ...
        parameters: [
          urnParam,
          { in: 'path', name: 'questionId', required: true, schema: { type: 'string' } },
        ],
        requestBody: {
          required: true,
          content: {
    ...
    '/api/v1/areas/{district}': {
      get: {
        tags: ['Areas'],
        summary: 'Get area summary for a postcode district',
        operationId: 'getArea',
        parameters: [
          {
            in: 'path',
    ...
    '/api/v1/areas/family-search': {
      get: {
        ...
        responses: jsonOk('Ranked districts', {
          type: 'object',
          properties: {
    ...
    '/api/v1/areas/{district}/nurseries': {
      get: {
        tags: ['Areas'],
        summary: 'List nurseries in a district',
    ...
    '/api/v1/properties/search': {
      get: {
        tags: ['Properties'],
        summary: 'Search properties by postcode',
    ...
    '/api/v1/properties/districts': {
      get: {
        tags: ['Properties'],
        summary: 'Browse districts by affordability and family score',
    ...
    '/api/v1/schools/near': {
      get: {
        tags: ['Overlays'],
        summary: 'Schools near a coordinate (alias)',
        operationId: 'schoolsNearAlias',
        parameters: [
          { in: 'query', name: 'lat', required: true, schema: { type: 'number' } },
          { in: 'query', name: 'lng', required: true, schema: { type: 'number' } },
          { in: 'query', name: 'radius_km', schema: { type: 'number', default: 2 } },
    ...
    '/api/v1/public/area/{district}.md': {
      get: {
        tags: ['Markdown'],
        summary: 'Markdown summary of a postcode district',
    ...
    '/api/v1/blog': {
      get: {
        tags: ['Blog'],
        summary: 'List blog/guide posts',
        operationId: 'listBlogPosts',
        responses: jsonOk('Posts', { type: 'object' }),
      },
    },
    '/api/v1/blog/{slug}': {
      get: {
    ...
    '/api/v1/enquiries': {
      post: {
        tags: ['Enquiries'],
        summary: 'Submit enquiries to nurseries',
        operationId: 'submitEnquiries',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  session_preference: {
                    type: 'string',
                    enum: ['full_day', 'half_day_am', 'half_day_pm', 'flexible'],
                    nullable: true,
                  },
        ...
        responses: {
          201: { description: 'Enquiries created (some may be queued for unclaimed nurseries)' },
          400: { description: 'Validation error' },
          429: { description: 'Rate limited (10/hour)' },
        },
      },
    },
    ...
    '/api/v1/enquiries/{enquiryId}/messages': {
      get: {
        tags: ['Enquiries'],
        summary: 'Get messages for an enquiry thread',
        operationId: 'getEnquiryMessages',
        security: [bearerAuth],
      ...
      post: {
        tags: ['Enquiries'],
        summary: 'Send a message in an enquiry thread',
        operationId: 'sendEnquiryMessage',
        security: [bearerAuth],
        parameters: [{ in: 'path', name: 'enquiryId', required: true, schema: { type: 'string' } }],
        requestBody: {
          required: true,
    ...
    '/api/v1/visits/slots/{urn}': {
      get: {
        tags: ['Visits'],
        summary: 'Get available visit slots for a nursery',
        operationId: 'getVisitSlots',
        parameters: [urnParam],
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['slot_id'],
                properties: { slot_id: { type: 'string' }, notes: { type: 'string' } },
              },
            },
          },
        },
    ...
    '/api/v1/visits/mine': {
      get: {
        tags: ['Visits'],
        summary: 'List my visit bookings',
        operationId: 'myVisits',
        security: [bearerAuth],
    ...
    '/api/v1/visits/{id}': {
      delete: {
        tags: ['Visits'],
        summary: 'Cancel a visit booking',
    ...
    '/api/v1/visits/{id}/survey': {
      post: {
        tags: ['Visits'],
        summary: 'Submit post-visit survey',
    ...
    '/api/v1/claims': {
      post: {
        tags: ['Claims'],
        summary: 'Submit a nursery claim',
          ...
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  urn: { type: 'string' },
                  claimer_name: { type: 'string' },
                  claimer_role: { type: 'string' },
      ...
      get: {
        tags: ['Claims'],
        summary: 'List all claims (public summary)',
    ...
    '/api/v1/recommendations': {
      get: {
        tags: ['Quiz'],
        summary: 'Get nursery recommendations based on quiz',
    ...
    '/api/v1/recommendations/tradeoffs': {
      get: {
        tags: ['Quiz'],
        summary: 'Get recommendation tradeoffs',
        operationId: 'getTradeoffs',
        security: [bearerAuth],
    ...
    '/api/v1/email/shortlist': {
      post: {
        tags: ['Email'],
        summary: 'Email shortlist to self',
        operationId: 'emailShortlist',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/email/comparison': {
      post: {
        tags: ['Email'],
        summary: 'Email comparison to self',
        operationId: 'emailComparison',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/travel/time': {
      post: {
        tags: ['Travel'],
        summary: 'Calculate travel time between two points',
        ...
        responses: jsonOk('Travel time', {
          type: 'object',
          properties: { duration_seconds: { type: 'number' }, distance_metres: { type: 'number' } },
        }),
      },
    },
    '/api/v1/travel/isochrone': {
      post: {
        tags: ['Travel'],
        summary: 'Generate isochrone polygon',
    ...
    '/api/v1/nurseries/{urn}/summary': {
      get: {
        tags: ['AI'],
        summary: 'AI-generated nursery summary',
        operationId: 'aiNurserySummary',
        parameters: [urnParam],
        responses: jsonOk('AI summary', {
          type: 'object',
    ...
    '/api/v1/nurseries/{urn}/review-synthesis': {
      get: {
        tags: ['AI'],
        summary: 'AI synthesis of nursery reviews',
        operationId: 'aiReviewSynthesis',
        parameters: [urnParam],
    ...
    '/api/v1/ai/match-narrative': {
      post: {
        tags: ['AI'],
        summary: 'AI narrative matching nurseries to preferences',
        operationId: 'aiMatchNarrative',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/ai/conversational-search': {
      post: {
        tags: ['AI'],
        summary: 'AI conversational nursery search',
    ...
    '/api/v1/assistant/chat': {
      post: {
        tags: ['AI'],
        summary: 'AI move assistant chat',
    ...
    '/api/v1/assistant/search': {
      post: {
        tags: ['AI'],
        summary: 'AI-powered search with context',
    ...
    '/api/v1/provider/nurseries': {
      get: {
        tags: ['Provider'],
        summary: "List provider's claimed nurseries",
        operationId: 'providerNurseries',
        security: [bearerAuth],
    ...
    '/api/v1/provider/features': {
      get: {
        tags: ['Provider'],
        summary: 'Get provider feature flags by tier',
        operationId: 'providerFeatures',
        security: [bearerAuth],
    ...
    '/api/v1/provider/nurseries/{urn}': {
      patch: {
        ...
        operationId: 'updateProviderNursery',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/photos': {
      get: {
        tags: ['Provider'],
        summary: 'List nursery photos',
        operationId: 'listProviderPhotos',
        security: [bearerAuth],
        parameters: [urnParam],
      ...
      post: {
        tags: ['Provider'],
        summary: 'Upload a nursery photo',
        operationId: 'uploadProviderPhoto',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: { image_base64: { type: 'string' }, caption: { type: 'string' } },
              },
            },
          },
        },
    ...
    '/api/v1/provider/nurseries/{urn}/photos/{photoId}': {
      delete: {
        tags: ['Provider'],
        summary: 'Delete a nursery photo',
        operationId: 'deleteProviderPhoto',
        security: [bearerAuth],
        parameters: [
          urnParam,
    ...
    '/api/v1/provider/nurseries/{urn}/fees': {
      get: {
        tags: ['Provider'],
        summary: 'List nursery fees',
        operationId: 'listProviderFees',
        security: [bearerAuth],
        parameters: [urnParam],
      ...
      post: {
        tags: ['Provider'],
        summary: 'Add a fee entry',
        operationId: 'addProviderFee',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/fees/{feeId}': {
      patch: {
        tags: ['Provider'],
        summary: 'Update a fee entry',
        operationId: 'updateProviderFee',
        security: [bearerAuth],
        parameters: [
          urnParam,
          { in: 'path', name: 'feeId', required: true, schema: { type: 'string' } },
        ],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/provider/nurseries/{urn}/availability': {
      get: {
        tags: ['Provider'],
        summary: 'Get nursery availability settings',
      ...
      put: {
        tags: ['Provider'],
        summary: 'Set nursery availability',
        operationId: 'setProviderAvailability',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/pricing': {
      get: {
        tags: ['Provider'],
        summary: 'Get nursery pricing data',
      ...
      post: {
        tags: ['Provider'],
        summary: 'Set nursery pricing',
        operationId: 'setProviderPricing',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/staff': {
      post: {
        ...
        operationId: 'updateProviderStaff',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/slots': {
      get: {
        tags: ['Provider Slots'],
        summary: 'List visit slots for a nursery',
        operationId: 'listProviderSlots',
        security: [bearerAuth],
        parameters: [urnParam],
        responses: jsonOk('Slots', { type: 'object' }),
      },
      post: {
        tags: ['Provider Slots'],
        summary: 'Create visit slots',
        operationId: 'createProviderSlots',
        security: [bearerAuth],
        parameters: [urnParam],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/nurseries/{urn}/slots/{id}': {
      delete: {
        ...
        operationId: 'deleteProviderSlot',
        security: [bearerAuth],
        parameters: [
          urnParam,
    ...
    '/api/v1/provider/enquiries': {
      get: {
        ...
        summary: 'List enquiries received by provider',
        operationId: 'listProviderEnquiries',
        security: [bearerAuth],
    ...
    '/api/v1/provider/enquiries/{id}': {
      patch: {
        ...
        operationId: 'updateProviderEnquiry',
        security: [bearerAuth],
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string' } }],
        requestBody: {
          required: true,
    ...
    '/api/v1/provider/analytics': {
      get: {
        tags: ['Provider Analytics'],
        summary: 'Get provider analytics dashboard data',
        operationId: 'providerAnalytics',
        security: [bearerAuth],
    ...
    '/api/v1/provider/reports/export': {
      get: {
        tags: ['Provider Analytics'],
        summary: 'Export provider reports as CSV',
        operationId: 'providerReportsExport',
        security: [bearerAuth],
        responses: {
    ...
    '/api/v1/provider-auth/register': {
      post: {
        tags: ['Provider'],
        summary: 'Register as a provider (combined signup + claim)',
    ...
    '/api/v1/billing/tiers': {
      get: {
        tags: ['Billing'],
        summary: 'Get available subscription tiers and pricing',
        operationId: 'billingTiers',
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  type: { type: 'string', enum: ['provider', 'parent'] },
                },
              },
            },
          },
        },
        responses: jsonOk('Checkout URL', {
          type: 'object',
        ...
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                properties: { type: { type: 'string', enum: ['provider', 'parent'] } },
              },
            },
          },
        },
        responses: jsonOk('Portal URL', {
          type: 'object',
          properties: { url: { type: 'string' } },
        }),
      },
    ...
    '/api/v1/promotions/{id}/impression': {
      post: {
        ...
        operationId: 'promotionImpression',
        parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string' } }],
        responses: { 204: { description: 'Recorded' } },
      },
    },
    ...
    '/api/v1/admin/stats/growth': {
      get: {
        tags: ['Admin'],
        summary: 'Growth metrics (week + month)',
        operationId: 'adminGrowth',
        security: [bearerAuth],
    ...
    '/api/v1/admin/analytics': {
      get: {
        tags: ['Admin'],
        summary: 'Enhanced analytics dashboard',
          ...
          content: {
            'application/json': {
              schema: {
                type: 'object',
                required: ['role'],
                properties: { role: { type: 'string', enum: ['customer', 'provider', 'admin'] } },
              },
            },
          },
        },
      ...
      get: {
        ...
        parameters: [
          ...paginationParams,
          {
            in: 'query',
            name: 'status',
            schema: { type: 'string', enum: ['pending', 'published', 'flagged', 'rejected'] },
          },
        ],
    ...
    '/api/v1/admin/enquiries': {
      get: {
        tags: ['Admin'],
        summary: 'List all enquiries with filters',
        operationId: 'adminListEnquiries',
        security: [bearerAuth],
        parameters: [
          ...paginationParams,
    ...
    '/api/v1/admin/bookings': {
      get: {
        tags: ['Admin'],
        summary: 'List all visit bookings with filters',
    ...
    '/api/v1/admin/ofsted-changes': {
      get: {
        tags: ['Admin'],
        summary: 'Recent Ofsted grade changes',
        operationId: 'adminOfstedChanges',
        security: [bearerAuth],
        parameters: [
          ...paginationParams,
          { in: 'query', name: 'notified', schema: { type: 'string', enum: ['true', 'false'] } },
        ],
    ...
    '/api/v1/admin/reports': {
      get: {
        tags: ['Admin'],
        summary: 'Platform reports (revenue, growth, coverage)',
    ...
    '/api/v1/admin/provider-invites/preview': {
      post: {
        tags: ['Admin Invites'],
        summary: 'Preview provider invite email',
        operationId: 'adminInvitePreview',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/admin/provider-invites/send': {
      post: {
        tags: ['Admin Invites'],
        summary: 'Send provider invite emails',
        operationId: 'adminInviteSend',
        security: [bearerAuth],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'object' } } },
    ...
    '/api/v1/admin/provider-invites/stats': {
      get: {
        tags: ['Admin Invites'],
        summary: 'Invite campaign stats',
        operationId: 'adminInviteStats',
        security: [bearerAuth],
        responses: jsonOk('Stats', { type: 'object' }),
      },
    },
    ...
    '/api/v1/ingest/ofsted': {
      post: {
        tags: ['Ingest'],
        summary: 'Ingest Ofsted CSV data',
        operationId: 'ingestOfsted',
        security: [bearerAuth],
    ...
    '/api/v1/ingest/geocode': {
      post: {
        tags: ['Ingest'],
        summary: 'Geocode nurseries via Postcodes.io',
        operationId: 'ingestGeocode',
        security: [bearerAuth],
        responses: { 200: { description: 'Geocoded' } },
      },
    },
    '/api/v1/ingest/aggregate-areas': {
      post: {
        tags: ['Ingest'],
        summary: 'Aggregate area stats from nurseries',
        operationId: 'ingestAggregateAreas',
        security: [bearerAuth],
    ...
    '/api/v1/ingest/property-stats': {
      post: {
        tags: ['Ingest'],
        summary: 'Refresh property stats',
        operationId: 'ingestPropertyStats',
        security: [bearerAuth],
    ...
    '/api/v1/ingest/land-registry': {
      post: {
        tags: ['Ingest'],
        summary: 'Ingest Land Registry price paid data',
        operationId: 'ingestLandRegistry',
        security: [bearerAuth],
        responses: { 200: { description: 'Ingested' } },
      },
    },
    '/api/v1/ingest/crime': {
      post: {
        tags: ['Ingest'],
        summary: 'Ingest police crime data',
        operationId: 'ingestCrime',
        security: [bearerAuth],
        responses: { 200: { description: 'Ingested' } },
      },
    },
    '/api/v1/ingest/imd': {
      post: {
        tags: ['Ingest'],
        summary: 'Ingest IMD deprivation data',
        operationId: 'ingestImd',
        security: [bearerAuth],
        responses: { 200: { description: 'Ingested' } },
      },
    },
    '/api/v1/ingest/family-scores': {
      post: {
        tags: ['Ingest'],
        summary: 'Recompute family scores',
        operationId: 'ingestFamilyScores',
        security: [bearerAuth],
        responses: { 200: { description: 'Computed' } },
      },
    },
    '/api/v1/ingest/dimension-scores': {
      post: {
        tags: ['Ingest'],
        summary: 'Recompute dimension scores',
        operationId: 'ingestDimensionScores',
        security: [bearerAuth],
        responses: { 200: { description: 'Computed' } },
      },
    },
    '/api/v1/ingest/schools': {
      post: {
        tags: ['Ingest'],
        summary: 'Ingest school data',
        operationId: 'ingestSchools',
        security: [bearerAuth],
        responses: { 200: { description: 'Ingested' } },
      },
    },
    '/api/v1/ingest/schools-geocode': {
      post: {
        tags: ['Ingest'],
        summary: 'Geocode schools',
        operationId: 'ingestSchoolsGeocode',
        security: [bearerAuth],
        responses: { 200: { description: 'Geocoded' } },
      },
    },
    ...
    '/api/v1/sitemap/nurseries': {
      get: {
        tags: ['Health'],
        summary: 'Sitemap nursery URLs',
        operationId: 'sitemapNurseries',
        responses: jsonOk('URLs', { type: 'object' }),
      },
    },
    '/api/v1/sitemap/districts': {
      get: {
        tags: ['Health'],
        summary: 'Sitemap district URLs',
        operationId: 'sitemapDistricts',
        responses: jsonOk('URLs', { type: 'object' }),
      },
    },
    '/api/v1/sitemap/towns': {
      get: {
        tags: ['Health'],
        summary: 'Sitemap town URLs',
        operationId: 'sitemapTowns',
        responses: jsonOk('URLs', { type: 'object' }),
      },
    },
    '/api/v1/sitemap/blog': {
    ...
    schemas: {
      ...
      AdminClaim: {
        ...
        properties: {
          id: { type: 'string' },
          urn: { type: 'string' },
          nursery_name: { type: 'string', nullable: true },
          claimer_name: { type: 'string' },
          claimer_email: { type: 'string' },
          status: { type: 'string' },
          created_at: { type: 'string', format: 'date-time' },
        },
      },
      ...
      AdminEnquiry: {
        ...
        properties: {
          ...
          nursery_id: { type: 'string' },
          nursery_name: { type: 'string', nullable: true },
          nursery_urn: { type: 'string', nullable: true },
          nursery_claimed: { type: 'boolean' },
          child_name: { type: 'string', nullable: true },
          message: { type: 'string', nullable: true },
          status: { type: 'string' },
