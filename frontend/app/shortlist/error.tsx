...
export default function ShortlistError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-center">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Could not load shortlist</h1>
      <p className="text-gray-500 mb-8">
        We were unable to load your shortlist. Your saved nurseries are safe — please try again.
      </p>
