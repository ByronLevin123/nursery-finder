...
export default function AreaFinderError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-center">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Area finder unavailable</h1>
      <p className="text-gray-500 mb-8">
        We could not load area data right now. Please try again in a moment.
      </p>
