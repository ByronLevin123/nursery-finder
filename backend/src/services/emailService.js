...
const FROM = process.env.EMAIL_FROM || 'NurseryMatch <info@nurserymatch.com>'
...
export function renderClaimApprovedEmail(nursery = {}, providerUrl = '') {
  ...
  const subject = `Your claim for ${escapeHtml(nursery.name || 'your nursery')} has been approved`
