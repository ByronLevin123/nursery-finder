...
export default function SearchError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-center">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Search unavailable</h1>
      <p className="text-gray-500 mb-8">
        We could not load nursery results right now. This is usually temporary — please try again.
      </p>
