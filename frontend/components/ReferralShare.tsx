...
const REFERRAL_URL =
  'https://nurserymatch.com/?utm_source=referral&utm_medium=share&utm_campaign=parent_referral'
const WHATSAPP_TEXT = `I've been using NurseryMatch to compare nurseries — check it out! ${REFERRAL_URL}`
const EMAIL_SUBJECT = 'Check out NurseryMatch'
const EMAIL_BODY = `I've been using NurseryMatch to find and compare nurseries for my family. You should check it out!\n\n${REFERRAL_URL}`
...
export default function ReferralShare() {
  ...
  function handleCopy() {
    navigator.clipboard.writeText(REFERRAL_URL).then(() => {
      setCopied(true)
      trackEvent('Referral Share' as any, { method: 'copy' })
      setTimeout(() => setCopied(false), 2000)
    })
  }

  function handleWhatsApp() {
    trackEvent('Referral Share' as any, { method: 'whatsapp' })
  }

  function handleEmail() {
    trackEvent('Referral Share' as any, { method: 'email' })
  }
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-600 mt-0.5">
            Know a parent looking for nurseries? Share NurseryMatch with them.
          </p>
