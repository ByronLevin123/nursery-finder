      ...
      {data && !loading && (
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            <StatCard
              label="Total Users"
              value={data.latest.total_users.toLocaleString()}
              icon={
            ...
            <StatCard
              ...
              value={data.latest.total_providers.toLocaleString()}
              icon={
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <StatCard
              label="MRR"
              value={`\u00A3${data.latest.mrr_gbp.toLocaleString()}`}
              icon={
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <StatCard
              ...
              value={data.latest.active_subscriptions.toLocaleString()}
              icon={
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <StatCard
              ...
              value={data.latest.claimed_nurseries.toLocaleString()}
              icon={
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <PipelineCard
                label="Pending"
                value={data.claim_pipeline.pending}
                color="border-yellow-300 bg-yellow-50 text-yellow-800"
              />
              <PipelineCard
                label="Approved"
                value={data.claim_pipeline.approved}
                color="border-blue-300 bg-blue-50 text-blue-800"
              />
              <PipelineCard
                label="Paying"
                value={data.claim_pipeline.paying}
