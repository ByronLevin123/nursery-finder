          ...
          <div className="flex gap-2 mb-4" ref={searchWrapperRef}>
            <div className="flex-1 relative">
              ...
              {showSuggestions && (suggestions.length > 0 || sugLoading) && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden max-h-[320px] overflow-y-auto">
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        {areas.length > 0 && (
                          <>
                            <div className="px-3 py-1.5 text-xs font-semibold text-gray-400 uppercase tracking-wide bg-gray-50">Areas</div>
                            {areas.map((s, i) => (
                              <button
                        ...
                        {nurseries.length > 0 && (
                          <>
                            <div className="px-3 py-1.5 text-xs font-semibold text-gray-400 uppercase tracking-wide bg-gray-50">Nurseries</div>
                            {nurseries.map((s, i) => (
                              <button
                                key={`nursery-${s.urn}-${i}`}
                                type="button"
